...
function PrijemnicaIzmeni() {
    ...
    const [prijemnica, setPrijemnica] = useState({brojPrijemnice:'',stavke:[]});
    ...
    const vratiPrijemnicu = () => {
        ...
        fetch(`${api_path}/prijemnica/${brojPrijemnice}`)
        .then(response => response.json())
        .then(result => {
            if (result.length !== 0){
    ...
    const sacuvajPrijemnicu = () => {
        ...
        fetch(`${api_path}/prijemnica/${brojPrijemnice}`, requestOptions)
        .then(response => response.json())
        ...
        <div className='prijemnicaPage'>
            <div className='prviRed'>           
                <div className="pronadjiOtpremnicu">
                    <label>Prijemnica</label><br/>
                    <TextField id="outlined-basic" label="Broj prijemnice" variant="outlined" 
                        margin='normal' type="number" className="sifraOtpremniceInput" name="sifraPrijemnice"
                        onChange={(e) => setBrojPrijemnice(e.target.value)} value={brojPrijemnice}
                    /><br/><br/>
